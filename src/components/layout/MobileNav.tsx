import { Home, Users, Calendar, CreditCard, Settings, GraduationCap, Coins, MessageSquare, UserCog, CheckSquare, Menu, UserCircle, Target, Tag, Sparkles, Bell } from 'lucide-react';
...
export function MobileNav({ currentPage, onNavigate, role }: MobileNavProps) {
  ...
  const ownerMainTabs = [
    { id: 'home', label: 'Главная', icon: Home },
    { id: 'leads', label: 'Клиенты', icon: Target },
  ...
  const ownerMenuItems = [
    ...
    { id: 'groups', label: 'Группы', icon: GraduationCap },
    { id: 'schedule', label: 'Расписание', icon: Calendar },
    { id: 'analytics', label: 'Аналитика', icon: MessageSquare },
    { id: 'team', label: 'Команда', icon: UserCog },
    { id: 'communication', label: 'Сообщения', icon: MessageSquare },
    { id: 'automations', label: 'Автоматизации', icon: Settings, desktopOnly: true },
    { id: 'profile', label: 'Профиль', icon: Settings },
  ];
