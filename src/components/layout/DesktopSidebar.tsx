...
import { Home, Users, Calendar, Settings, CreditCard, GraduationCap, Target, UserCircle, MessageSquare, CheckSquare, Zap, BarChart3, LogOut, ChevronRight, Menu, Tag, Sparkles, Bell, FileText, UserCheck, CalendarClock, Receipt } from 'lucide-react';
