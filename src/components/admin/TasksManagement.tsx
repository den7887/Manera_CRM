                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-wrap items-center gap-3 text-sm text-[#133C2A]/60">
                        ...
                        {/* Due Date */}
                        {task.dueDate && (
                          <div className={`flex items-center gap-1 ${overdue ? 'text-[#D14343]' : ''}`}>
                        ...
                        {task.relatedUserName && (
                          <Badge
                            className="rounded-full bg-[#133C2A]/8 text-[#133C2A] border-[#133C2A]/20 text-xs cursor-pointer hover:bg-[#133C2A]/14"
                          >
                        ...
                        {task.relatedChildName && (
                          <Badge
                            className="rounded-full bg-[#FADADD]/60 text-[#B85A6B] border-[#FADADD] text-xs cursor-pointer hover:bg-[#FADADD]"
                          >
