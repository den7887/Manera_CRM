...
const categoryConfig = {
  leads: {
    label: 'База клиентов',
    icon: Target,
    color: 'from-[#133C2A] to-[#0F3021]',
    bgColor: 'bg-[#EEF5F0]',
    textColor: 'text-[#133C2A]',
    borderColor: 'border-[#133C2A]/20',
  },
  subscriptions: {
    label: 'Абонементы',
    icon: CreditCard,
    ...
    bgColor: 'bg-[#FFF9E8]',
    textColor: 'text-[#8B6B00]',
    borderColor: 'border-[#D4AF37]/30',
  },
  users: {
    label: 'Пользователи',
    icon: Users,
    color: 'from-[#1C8C64] to-[#15694A]',
    bgColor: 'bg-[#EAF7F1]',
    textColor: 'text-[#1C8C64]',
    borderColor: 'border-[#1C8C64]/25',
  },
  birthdays: {
    label: 'Дни рождения',
    icon: Cake,
    color: 'from-[#FADADD] to-[#FFC0CB]',
    bgColor: 'bg-[#FFF3F4]',
    textColor: 'text-[#B85A6B]',
    borderColor: 'border-[#FADADD]',
  },
};
